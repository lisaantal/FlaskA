...
#[derive(Debug)]
pub struct FlaskAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FlaskAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FlaskAPI processing");
    
    let mut processor = FlaskAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FlaskAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FlaskAPIProcessor::new(false);
